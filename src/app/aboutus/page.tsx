...
const About_us_page = () => {
  return (
    <>
      ...
      <div className=' h-[60vh] flex items-center justify-center bg-[url("/aboutus.jpg")]  bg-cover bg-center bg-no-repeat bg-aboutsection  w-[100%]   '>
        <div>
          <h1 className='title font-bold text-white tracking-wider text-3xl'>
            About Us
          </h1>
        </div>
      </div>
        ...
        <div className='flex my-4 flex-col md:flex-row-reverse md:items-center'>
          ...
          <div className='mx-3 flex flex-col justify-center items-center'>
            ...
            <p className=' mb-2 md:text-center md:w-[70%] px-2'>
              ...
              chance to lead a healthy, active life, and we are here to support
        ...
        <div>
          ...
          <div className='md:4/5  p-8 '>
            <ul className='space-y-2 text-left flex flex-col   '>
              ...
              <li className='list-disc  md:p-2  '>
                <span>Introducing high-efficiency showers to save water.</span>
              </li>
              <li className='list-disc  md:p-2  '>
                <span>
        ...
        <div className='flex flex-col justify-center items-center  mx-2'>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8 mt-6 md:w-[55%]'>
            ...
            <div className='flex flex-col  justify-center items-center text-center py-3'>
              ...
              <div className='ml-4'>
                <h3 className='font-semibold text-red-600'>Bring Your Towel</h3>
                <p className='text-sm'>
            ...
            <div className='flex flex-col  justify-center items-center text-center py-3'>
              ...
              <div className='ml-4'>
                ...
                <p className='text-sm'>
                  Public transport, walking, jogging, or cycling are great ways
                  to travel sustainably to the gym.
                </p>
              </div>
            </div>
          </div>
